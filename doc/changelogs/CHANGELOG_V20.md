...
* \[[`a5943ca6ad`](https://github.com/nodejs/node/commit/a5943ca6ad)] - **benchmark**: --no-warnings to avoid DEP/ExpWarn log (Rafael Gonzaga) [#54928](https://github.com/nodejs/node/pull/54928)
...
* \[[`c1b1fe1216`](https://github.com/nodejs/node/commit/c1b1fe1216)] - **build**: upgrade clang-format to v18 (Aviv Keller) [#53957](https://github.com/nodejs/node/pull/53957)
* \[[`193ea62872`](https://github.com/nodejs/node/commit/193ea62872)] - **build**: fix conflicting V8 object print flags (Daeyeon Jeong) [#54785](https://github.com/nodejs/node/pull/54785)
...
* \[[`2b281d8028`](https://github.com/nodejs/node/commit/2b281d8028)] - **deps**: update cjs-module-lexer to 1.4.1 (Node.js GitHub Bot) [#54846](https://github.com/nodejs/node/pull/54846)
* \[[`f12bdbe522`](https://github.com/nodejs/node/commit/f12bdbe522)] - **deps**: update simdutf to 5.5.0 (Node.js GitHub Bot) [#54434](https://github.com/nodejs/node/pull/54434)
* \[[`98bf653649`](https://github.com/nodejs/node/commit/98bf653649)] - **deps**: upgrade npm to 10.8.3 (npm team) [#54619](https://github.com/nodejs/node/pull/54619)
...
* \[[`1a038d8f31`](https://github.com/nodejs/node/commit/1a038d8f31)] - **doc**: add missing EventSource docs to globals (Matthew Aitken) [#55022](https://github.com/nodejs/node/pull/55022)
* \[[`9f6f00555d`](https://github.com/nodejs/node/commit/9f6f00555d)] - **doc**: fix broken Android building link (Niklas Wenzel) [#54922](https://github.com/nodejs/node/pull/54922)
* \[[`d8fcd8f213`](https://github.com/nodejs/node/commit/d8fcd8f213)] - **doc**: add support link for aduh95 (Antoine du Hamel) [#54866](https://github.com/nodejs/node/pull/54866)
* \[[`340f8f610d`](https://github.com/nodejs/node/commit/340f8f610d)] - **doc**: run license-builder (github-actions\[bot]) [#54854](https://github.com/nodejs/node/pull/54854)
* \[[`e26a13e9d7`](https://github.com/nodejs/node/commit/e26a13e9d7)] - **doc**: experimental flag for global accessible APIs (Chengzhong Wu) [#54330](https://github.com/nodejs/node/pull/54330)
...
* \[[`7229fbd281`](https://github.com/nodejs/node/commit/7229fbd281)] - **doc, build**: fixup build docs (Aviv Keller) [#54899](https://github.com/nodejs/node/pull/54899)
...
* \[[`411ad0e40c`](https://github.com/nodejs/node/commit/411ad0e40c)] - **doc, meta**: fix broken link in `onboarding.md` (Aviv Keller) [#54886](https://github.com/nodejs/node/pull/54886)
...
* \[[`feab608f0c`](https://github.com/nodejs/node/commit/feab608f0c)] - **esm**: fix support for `URL` instances in `import.meta.resolve` (Antoine du Hamel) [#54690](https://github.com/nodejs/node/pull/54690)
* \[[`c3ac844bfe`](https://github.com/nodejs/node/commit/c3ac844bfe)] - **fs**: refactor rimraf to avoid using primordials (Yagiz Nizipli) [#54834](https://github.com/nodejs/node/pull/54834)
...
* \[[`4990ac89f0`](https://github.com/nodejs/node/commit/4990ac89f0)] - **http**: reduce likelihood of race conditions on keep-alive timeout (jazelly) [#54863](https://github.com/nodejs/node/pull/54863)
...
* \[[`c40bc45831`](https://github.com/nodejs/node/commit/c40bc45831)] - **lib**: remove unnecessary async (jakecastelli) [#54829](https://github.com/nodejs/node/pull/54829)
* \[[`9a8d71aa13`](https://github.com/nodejs/node/commit/9a8d71aa13)] - **lib**: make WeakRef safe in abort\_controller (jazelly) [#54791](https://github.com/nodejs/node/pull/54791)
...
* \[[`be6e3eb685`](https://github.com/nodejs/node/commit/be6e3eb685)] - **meta**: bump peter-evans/create-pull-request from 6.1.0 to 7.0.1 (dependabot\[bot]) [#54820](https://github.com/nodejs/node/pull/54820)
...
* \[[`baafdb8239`](https://github.com/nodejs/node/commit/baafdb8239)] - **node-api**: add external buffer creation benchmark (Chengzhong Wu) [#54877](https://github.com/nodejs/node/pull/54877)
* \[[`ca21d8e5ae`](https://github.com/nodejs/node/commit/ca21d8e5ae)] - **node-api**: add support for UTF-8 and Latin-1 property keys (Mert Can Altin) [#52984](https://github.com/nodejs/node/pull/52984)
...
* \[[`fee1a2d4eb`](https://github.com/nodejs/node/commit/fee1a2d4eb)] - **path**: remove `StringPrototypeCharCodeAt` from `posix.extname` (Aviv Keller) [#54546](https://github.com/nodejs/node/pull/54546)
...
* \[[`05bbd82f22`](https://github.com/nodejs/node/commit/05bbd82f22)] - **repl**: avoid interpreting 'npm' as a command when errors are recoverable (Shima Ryuhei) [#54848](https://github.com/nodejs/node/pull/54848)
* \[[`74b25482cd`](https://github.com/nodejs/node/commit/74b25482cd)] - **repl**: doc-deprecate instantiating `node:repl` classes without `new` (Aviv Keller) [#54842](https://github.com/nodejs/node/pull/54842)
...
* \[[`d24404298f`](https://github.com/nodejs/node/commit/d24404298f)] - **src**: add Cleanable class to Environment (Gabriel Schulhof) [#54880](https://github.com/nodejs/node/pull/54880)
...
* \[[`693af3f6c3`](https://github.com/nodejs/node/commit/693af3f6c3)] - **test**: adjust test-tls-junk-server for OpenSSL32 (Michael Dawson) [#54926](https://github.com/nodejs/node/pull/54926)
* \[[`196ca912b7`](https://github.com/nodejs/node/commit/196ca912b7)] - **test**: adjust tls test for OpenSSL32 (Michael Dawson) [#54909](https://github.com/nodejs/node/pull/54909)
* \[[`d82df743ee`](https://github.com/nodejs/node/commit/d82df743ee)] - **test**: fix test-http2-socket-close.js (Hüseyin Açacak) [#54900](https://github.com/nodejs/node/pull/54900)
* \[[`1a0837dd68`](https://github.com/nodejs/node/commit/1a0837dd68)] - **test**: improve test-internal-fs-syncwritestream (Sunghoon) [#54671](https://github.com/nodejs/node/pull/54671)
* \[[`501b8df829`](https://github.com/nodejs/node/commit/501b8df829)] - **test**: deflake test-dns (Luigi Pinca) [#54902](https://github.com/nodejs/node/pull/54902)
* \[[`ee1be2db0a`](https://github.com/nodejs/node/commit/ee1be2db0a)] - **test**: fix test test-tls-dhe for OpenSSL32 (Michael Dawson) [#54903](https://github.com/nodejs/node/pull/54903)
* \[[`176fb4da61`](https://github.com/nodejs/node/commit/176fb4da61)] - **test**: use correct file naming syntax for `util-parse-env` (Aviv Keller) [#53705](https://github.com/nodejs/node/pull/53705)
* \[[`e836f4863e`](https://github.com/nodejs/node/commit/e836f4863e)] - **test**: add missing await (Luigi Pinca) [#54828](https://github.com/nodejs/node/pull/54828)
* \[[`1190f8d290`](https://github.com/nodejs/node/commit/1190f8d290)] - **test**: move more url tests to `node:test` (Yagiz Nizipli) [#54636](https://github.com/nodejs/node/pull/54636)
* \[[`ca0e30acbc`](https://github.com/nodejs/node/commit/ca0e30acbc)] - **test**: strip color chars in `test-runner-run` (Giovanni Bucci) [#54552](https://github.com/nodejs/node/pull/54552)
* \[[`b6aeb98c94`](https://github.com/nodejs/node/commit/b6aeb98c94)] - **test**: deflake test-http2-misbehaving-multiplex (Luigi Pinca) [#54872](https://github.com/nodejs/node/pull/54872)
* \[[`30d5af633e`](https://github.com/nodejs/node/commit/30d5af633e)] - **test**: remove dead code in test-http2-misbehaving-multiplex (Luigi Pinca) [#54860](https://github.com/nodejs/node/pull/54860)
* \[[`94f242c5ce`](https://github.com/nodejs/node/commit/94f242c5ce)] - **test**: reduce test-esm-loader-hooks-inspect-wait flakiness (Luigi Pinca) [#54827](https://github.com/nodejs/node/pull/54827)
* \[[`729158c688`](https://github.com/nodejs/node/commit/729158c688)] - **test**: reduce the allocation size in test-worker-arraybuffer-zerofill (James M Snell) [#54839](https://github.com/nodejs/node/pull/54839)
* \[[`2676dc1574`](https://github.com/nodejs/node/commit/2676dc1574)] - **test**: fix test-tls-client-mindhsize for OpenSSL32 (Michael Dawson) [#54739](https://github.com/nodejs/node/pull/54739)
* \[[`d5df08d2ba`](https://github.com/nodejs/node/commit/d5df08d2ba)] - **test**: use platform timeout (jakecastelli) [#54591](https://github.com/nodejs/node/pull/54591)
* \[[`dac9771e00`](https://github.com/nodejs/node/commit/dac9771e00)] - **test**: reduce fs calls in test-fs-existssync-false (Yagiz Nizipli) [#54815](https://github.com/nodejs/node/pull/54815)
* \[[`195c2e835e`](https://github.com/nodejs/node/commit/195c2e835e)] - **test**: move test-http-server-request-timeouts-mixed (James M Snell) [#54841](https://github.com/nodejs/node/pull/54841)
...
* \[[`6ae9fc047d`](https://github.com/nodejs/node/commit/6ae9fc047d)] - **test\_runner**: reimplement `assert.ok` to allow stack parsing (Aviv Keller) [#54776](https://github.com/nodejs/node/pull/54776)
* \[[`5c4f2d2685`](https://github.com/nodejs/node/commit/5c4f2d2685)] - **test\_runner**: improve code coverage cleanup (Colin Ihrig) [#54856](https://github.com/nodejs/node/pull/54856)
...
* \[[`20ae26d90f`](https://github.com/nodejs/node/commit/20ae26d90f)] - **timers**: avoid generating holey internal arrays (Gürgün Dayıoğlu) [#54771](https://github.com/nodejs/node/pull/54771)
...
* \[[`52d6571208`](https://github.com/nodejs/node/commit/52d6571208)] - **(SEMVER-MINOR)** **tls**: add `allowPartialTrustChain` flag (Anna Henningsen) [#54790](https://github.com/nodejs/node/pull/54790)
...
* \[[`4eb0749b6c`](https://github.com/nodejs/node/commit/4eb0749b6c)] - **(SEMVER-MINOR)** **url**: implement parse method for safer URL parsing (Ali Hassan) [#52280](https://github.com/nodejs/node/pull/52280)
* \[[`47be236f9e`](https://github.com/nodejs/node/commit/47be236f9e)] - **vm**: harden module type checks (Chengzhong Wu) [#52162](https://github.com/nodejs/node/pull/52162)
